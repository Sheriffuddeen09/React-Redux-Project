...
import TaskInputList from "../main_task/TaskInputList";

const Sidebar = ({theme, handleSide, sidebar}) => {
  ...
  const content = (
        ...
        <path stroke-linecap="round" stroke-linejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
          ...
          <span className="block w-full h-0.5 my-5 bg-gray-100"></span>
            ...
            <div className={`circle mx-auto ${theme}`}></div>
  ...
  return (
    <aside className={`w-64 bg-white shadow-md p-4 app ${theme} ${sidebar ? "block" : "hidden"}`}>
      {/* Logo and Header */}
      ...
      <div className={` flex flex-col justify-center side ${theme}`}>
      <h2 className="text-sm text-center font-bold mt-14 mb-4">Hey, ABCD</h2>

      {/* Navigation */}
      <nav className={`space-y-4 mx-auto content ${theme}  w-48 p-2 rounded`}>
  <a
    href="#"
    className="flex items-center gap-2 p-2 font-medium hover:bg-gray-400 rounded"
  >
  ...
  <a
    href="#"
    className={`flex items-center gap-2 p-2 font-medium hover:bg-gray-400 today ${theme} rounded`}
  >
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<div className={` w-48 flex p-2 items-center mx-auto mt-2 content ${theme} rounded`}>
<button
    className="flex items-center gap-2 p-2 font-medium hover:bg-gray-400 w-full rounded"
  >
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
